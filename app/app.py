...
def apply_limiter():
    if request.endpoint:
        if request.endpoint == 'auth.login':
            limiter.limit("150 per 15 minutes", key_func=lambda: 'login:' + get_remote_address())(lambda: None)()
        elif request.endpoint == 'auth.forgot_password':
            limiter.limit("150 per 15 minutes", key_func=lambda: 'forgot:' + get_remote_address())(lambda: None)()
        elif request.endpoint == 'auth.reset_password':
            limiter.limit("150 per 15 minutes", key_func=lambda: 'reset:' + get_remote_address())(lambda: None)()
        elif request.endpoint == 'misc.pod_krinko.new_words':
            limiter.limit("150 per 15 minutes", key_func=lambda: 'pod_krinko:' + get_remote_address())(lambda: None)()
